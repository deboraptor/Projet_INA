...
fichiers = glob.glob("../emotions/output/*_traite.csv")
...
for fichier in fichiers:
    ...
    nom_fichier = os.path.basename(fichier).replace("_output_traite.csv", "_traite_zipf.png")
...
nom_fichier_total = "total_traite_zipf.png"
